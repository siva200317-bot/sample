...
export default function Modal({ open, onClose, title = "", children }) {
  ...
  return (
    <div
      ...
      className={`fixed inset-0 z-[9999] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 transition-opacity duration-300 ${visible ? "opacity-100" : "opacity-0"}`}
      aria-hidden={!open}
    >
      <div
        ref={panelRef}
